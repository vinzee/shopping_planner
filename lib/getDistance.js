    ...
    if(!_.isEmpty(path)){
        ...
        for(var i in path){
            ...
            for(var j in path[i].data){
                ...
                // TODO - can use the given distance instead of calculating
                // console.log("\n distance - " , dist, " , " , path[i].data[j].distance);
        ...
        for(var i in newIndices){
            ...
            response.path.push(minDistShops[index]);
